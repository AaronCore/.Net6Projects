...
namespace WebApp
{
    public class AutofacModule : Autofac.Module
    {
        ...
        public AutofacModule(IEnumerable<Assembly> assembliesToScan)
        {
        ...
        {
            base.Load(builder);
            var assemblies = this.assembliesToScan as Assembly[] ?? this.assembliesToScan.ToArray();
            ...
            builder.Register<IConfigurationProvider>(ctx => new MapperConfiguration(cfg => cfg.AddMaps(assemblies))).SingleInstance();
