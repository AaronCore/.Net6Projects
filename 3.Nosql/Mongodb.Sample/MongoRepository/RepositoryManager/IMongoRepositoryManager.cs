...
namespace MongoRepository
{
    ...
    public interface IMongoRepositoryManager<T, TKey> where T : IEntity<TKey>
    {
        /// <summary>
    ...
    public interface IRepositoryManager<T> : IMongoRepositoryManager<T, string> where T : IEntity<string>
    { }
}
