...
namespace MongoRepository
{
    ...
    public class MongoRepositoryManager<T, TKey> : IMongoRepositoryManager<T, TKey> where T : IEntity<TKey>
    {
        /// <summary>
        ...
        public MongoRepositoryManager() : this(Util<TKey>.GetDefaultConnectionString())
        {
        }
